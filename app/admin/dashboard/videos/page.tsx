          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="e.g. How AI Tools Work"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="e.g. GN7yQntWJHU"
              />
              <p className="text-xs text-muted-foreground">
                The ID from the YouTube URL (e.g. youtube.com/watch?v=<strong>GN7yQntWJHU</strong>)
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="tutorial, AI, education"
              />
            </div>
